...
(function($) {
  ...
  will_pickdate.prototype = {
    ...
    pickerPosition: function() {
      ...
      var position = { left: this.visual.offset().left + this.options.positionOffset.x+8,
    ...
    renderTime: function() {
      ...
      container.append($('<input type="text" class="hour"' + (this.options.militaryTime ? ' style="left:0px"' : '') +
            ' maxlength="2" value="' +
      ...
      container.append($('<input type="text" class="minutes"' + (this.options.militaryTime ? ' style="left:75px"' : '') + ' maxlength="2" value="' +
      ...
      container.append($('<input type="text" class="seconds"' + (this.options.militaryTime ? ' style="left:150px"' : '') + ' maxlength="2" value="' +
              this.leadZero(this.working_date.getSeconds()) + '"/>').mousewheel($.proxy(function(event, d, dx, dy) {
        event.preventDefault();
        event.stopPropagation();
      ...
      container.append($('<div class="separator"' + (this.options.militaryTime ? ' style="left:58px"' : '') + '>:</div>'));
      container.append($('<div class="separator"' + (this.options.militaryTime ? ' style="left:134px"' : '') + '>:</div>'));
        ...
        this.select($.extend(this.dateToObject(this.working_date),
          {
            ...
            seconds: parseInt(this.picker.find('.seconds').val(), 10)
      	  }));
      }, this)));
    },
