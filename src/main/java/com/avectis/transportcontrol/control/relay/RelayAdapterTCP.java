...
import com.avectis.transportcontrol.control.barrier.*;
 ...
 */
public class RelayAdapterTCP implements RelayAdapter{
    ...
    public RelayAdapterTCP(){}
    public RelayAdapterTCP(String IP, int port, byte unitId, int pulseLength){        
            this.ipAddr = IP;
            this.port = port;
            this.unitId = unitId;
